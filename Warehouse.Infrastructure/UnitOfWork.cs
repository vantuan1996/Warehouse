...
namespace Warehouse.Infrastructure
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        {
            // Gán vào biến private của class để Commit/Rollback có thể truy cập
        ...
        public async Task CommitTransactionAsync()
        {
            ...
            {
                throw new InvalidOperationException("Transaction chưa được khởi tạo hoặc đã kết thúc.");
            }

            try
            {
                // KHÔNG gọi SaveChangesAsync ở đây nữa, vì ta đã gọi ở Service rồi.
                // Chỉ tập trung vào việc Commit cái transaction đang mở thôi.
